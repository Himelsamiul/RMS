...
<div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="{{ route('dashboard')}}" role="button" > 
                      <svg class="svg-icon svg-icon-md me-3">
                        
                      </svg><span class="sidebar-link-title">Dashboards </span></a>

              </li>
              <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="{{ route('category.list')}}"  role="button" > 
                      <svg class="svg-icon svg-icon-md me-3">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="{{ route('customer.list')}}"  role="button">
                      <svg class="svg-icon svg-icon-md me-3">
